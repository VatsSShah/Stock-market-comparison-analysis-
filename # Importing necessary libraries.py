...
# Defining the stock tickers for Apple and Google
apple_ticker = 'AAPL'
google_ticker = 'GOOGL'

# Specifying the date range for the last quarter
...
# Fetching S&P 500 index data as the market benchmark
...
# Comparing Beta values to draw conclusions
